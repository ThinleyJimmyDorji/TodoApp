...
function updateWorkspaceJsonToMatchFormatVersion(tree) {
    ...
    try {
        ...
        if (reformatted) {
            json_1.writeJson(tree, path, reformatted);
        }
    }
    catch (e) {
...
function sortNxJson(tree) {
    try {
        const nxJson = json_1.readJson(tree, 'nx.json');
        const sortedProjects = object_sort_1.sortObjectByKeys(nxJson.projects);
        json_1.writeJson(tree, 'nx.json', Object.assign(Object.assign({}, nxJson), { projects: sortedProjects }));
    }
    catch (e) {
        // catch noop
    }
