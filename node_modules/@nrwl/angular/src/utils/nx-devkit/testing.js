...
function createApp(tree, appName, routing = true) {
    appName = devkit_1.names(appName).fileName;
  ...
  `);
    ...
    devkit_1.updateJson(tree, './nx.json', (json) => (Object.assign(Object.assign({}, json), { projects: Object.assign(Object.assign({}, json.projects), { [appName]: { tags: [] } }) })));
}
exports.createApp = createApp;
function createLib(tree, libName) {
    const { name, className, fileName, propertyName } = devkit_1.names(libName);
    libConfig = {
        name,
