...
function updateModuleBootstrap(tree, options) {
    ...
    moduleSource = ast_utils_1.addParameterToConstructor(tree, moduleSource, modulePath, {
        className: moduleClassName,
        param: 'private upgrade: UpgradeModule',
    });
    moduleSource = ast_utils_1.addMethod(tree, moduleSource, modulePath, {
        className: moduleClassName,
...
`,
    ...
    ast_utils_2.removeFromNgModule(tree, moduleSource, modulePath, 'bootstrap');
}
