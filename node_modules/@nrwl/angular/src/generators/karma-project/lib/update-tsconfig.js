...
function updateTsConfigs(tree, project) {
    ...
    devkit_1.updateJson(tree, devkit_1.joinPathFragments(projectConfig.root, 'tsconfig.json'), (json) => {
    ...
    return devkit_1.updateJson(tree, devkit_1.joinPathFragments(projectConfig.root, 'tsconfig.spec.json'), (json) => {
