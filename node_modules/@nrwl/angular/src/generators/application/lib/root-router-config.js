...
function addRouterRootConfiguration(host, options) {
    ...
    sourceFile = ast_utils_1.insertImport(host, sourceFile, modulePath, 'RouterModule', '@angular/router');
    sourceFile = ast_utils_2.addImportToModule(host, sourceFile, modulePath, `RouterModule.forRoot([], {initialNavigation: 'enabledBlocking'})`);
}
