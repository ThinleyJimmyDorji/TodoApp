...
function webWorkerGenerator(tree, rawOptions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const options = lib_1.normalizeOptions(rawOptions);
        const { skipFormat } = options, schematicOptions = tslib_1.__rest(options, ["skipFormat"]);
        const webWorkerSchematic = ngcli_adapter_1.wrapAngularDevkitSchematic('@schematics/angular', 'web-worker');
        yield webWorkerSchematic(tree, schematicOptions);
        lib_1.updateTsConfig(tree, options.project);
        if (!skipFormat) {
