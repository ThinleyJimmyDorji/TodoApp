...
function addLazyLoadedRouterConfiguration(host, options) {
    ...
    sourceFile = ast_utils_2.addImportToModule(host, sourceFile, options.modulePath, `
    RouterModule.forChild([
      /* {path: '', pathMatch: 'full', component: InsertYourComponentHere} */
    ]) `);
    sourceFile = ast_utils_1.insertImport(host, sourceFile, options.modulePath, 'RouterModule', '@angular/router');
}
