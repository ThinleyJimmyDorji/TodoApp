...
function addRouterConfiguration(host, options) {
    ...
    moduleSourceFile = ast_utils_2.addImportToModule(host, moduleSourceFile, options.modulePath, `RouterModule`);
    moduleSourceFile = ast_utils_1.insertImport(host, moduleSourceFile, options.modulePath, 'RouterModule, Route', '@angular/router');
    moduleSourceFile = ast_utils_1.addGlobal(host, moduleSourceFile, options.modulePath, `export const ${constName}: Route[] = [];`);
}
