...
function createEsLintConfiguration(tree, options) {
    const rootConfig = `${devkit_1.offsetFromRoot(options.projectRoot)}.eslintrc.json`;
    ...
    devkit_1.writeJson(tree, devkit_1.joinPathFragments(options.projectRoot, '.eslintrc.json'), configJson);
}
